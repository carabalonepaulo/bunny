...
type Matrix* = enum 
converter Matrix2int32* (self: Matrix): int32 = self.int32 
...
proc rlSetFramebufferWidth*(width: int32) {.RLAPI, importc: "rlSetFramebufferWidth".} # Set current framebuffer width
proc rlGetFramebufferWidth*(): int32 {.RLAPI, importc: "rlGetFramebufferWidth".} # Get default framebuffer width
proc rlSetFramebufferHeight*(height: int32) {.RLAPI, importc: "rlSetFramebufferHeight".} # Set current framebuffer height
